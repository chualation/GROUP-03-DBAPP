...
public class ReportPanel extends JPanel {
    ...
    public ReportPanel() {
        ...
        // 🔒 Make report table non-editable (still selectable/scrollable)
        table.setDefaultEditor(Object.class, null);

        // Row coloring for LOW stock (keeps selection highlight intact)
    ...
    public void loadReport() {
        ...
        try (Connection c = DBUtils.getConn();
            ...
            while (rs.next()) {
                ...
                String status = (stock.compareTo(BigDecimal.ZERO) == 0) ? "OUT OF STOCK"
                        : (stock.compareTo(reorder) < 0) ? "LOW"
                        : "OK";
