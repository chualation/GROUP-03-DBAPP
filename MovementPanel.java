...
public class MovementPanel extends JPanel {
    ...
    public MovementPanel(ReportPanel rp) {
        ...
        // 🔒 Make table cells non-editable (still allows selection & scrolling)
        ...
        // ----- ACTIONS -----
        btnLoad.addActionListener(e -> { loadComboData(); loadMovements(); });
    ...
    private void addMovement() {
        ...
        String sql =
                "INSERT INTO StockMovement (product_id, location_id, supplier_id, quantity, " +
                        "movement_type, movement_date, reason) VALUES (?,?,?,?,?,?,?)";
        try (Connection c = DBUtils.getConn();
             PreparedStatement ps = c.prepareStatement(sql)) {
    ...
    public static class Item {
        public int id;
        public String name;
        public Item(int i, String n) { id = i; name = n; }
